...
export default function Dashboard(){
  ...
  const { records: patients, loading, isOnline, pendingCount, addRecord, deleteRecord } =
  ...
  async function loadOverviewSummary(){
    ...
    const { data: apptData } =
      await supabase.from('appointments').select('appointment_time, status')
    ...
    const { data: invData } =
      await supabase.from('invoices').select('amount, status')
  ...
  const displayedPatients = pending
    ? patients.filter(p => p.id !== pending.patient.id)
    : patients
  ...
  return (
    <div className="dash-shell">
      ...
      <aside className={`dash-sidebar ${drawerOpen ? 'open' : ''}`}>
        ...
        <div className="dash-foot">
          <div className="dash-foot-user">
            ...
            <div>
              <div className="dash-foot-name">
                {profile?.full_name}
              </div>

              <div className="dash-foot-role">
                Admin
              </div>
            </div>
          </div>
            ...
            >
              {stuckTables.map(err => (
                ...
                >
                  ...
                  >
                    {err.queueLength} item
                    {err.queueLength === 1 ? '' : 's'} waiting to sync
                  </div>
            ...
            <>
              <div className="dash-stats">
                ...
                <StatCard
                  icon={<ReviewIcon />}
                  iconStyle={{
                    background: 'rgba(232,184,46,.12)',
                    color: 'var(--gold)'
                  }}
                  label="In Review"
                  value={inReviewCount}
                  delta="Needs attention"
                  deltaStyle={{ color: 'var(--gold)' }}
                />
                ...
                <StatCard
                  ...
                  delta={`${upcomingApptCount} upcoming`}
                />
                ...
                <StatCard
                  ...
                  delta={`${formatMoney(revenueOutstanding)} outstanding`}
                  deltaStyle={{
                    color:
                  ...
                  <div className="dash-panel-head">
                    <div>
                      ...
                      <div className="dash-panel-sub">
                        Cyan = rising, Red = falling — live data
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="dash-donut-box">
                      ...
                      <div
                        ...
                        style={{
                          background:
                            'radial-gradient(circle, var(--bg-card) 60%, transparent 61%)'
                        }}
                      >
                        <b>{patients.length}</b>
                        <span>Total</span>
            ...
            <div className="dash-panel">
              ...
              <div className="dash-panel-head">
                ...
                <div>
                  ...
                  <div className="dash-panel-sub">
                    Only {hospital?.name || 'your hospital'} can see this list
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    <div
                      ...
                      style={{ fontSize: 14.5 }}
                    >
                      Doctor's Orders — {selectedOrdersPatient}
                    </div>
                  ...
                  {(() => {
                    ...
                    if (orders.length === 0) {
                      return (
                        ...
                        >
                          No active doctor's orders for {selectedOrdersPatient}.
                        </div>
                      )
                    }
      ...
      {pending ? (
        ...
        >
          <span>
            {pending.patient.full_name} removed (
...
function PatientIcon({ size = 19 }) {
  return (
    ...
    >
      ...
      <path d="M2 21c0-3.8 3.1-7 7-7s7 3.2 7 7" />
...
function NavIcon({ item }) {
  ...
  if (item === 'patients') return <PatientIcon size={16} />
  if (item === 'appointments') return <CalendarIcon size={16} />
